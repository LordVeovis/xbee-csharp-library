...
namespace Kveer.XBeeApi.Exceptions
{
	...
	{
		/// <summary>
		/// Initializes a new instance of the <see cref="XBeeDeviceException"/> class.
		/// </summary>
		public XBeeDeviceException() : base() { }

		/// <summary>
		/// Initializes a new instance of the <see cref="XBeeDeviceException"/> class with the exception that is the cause of this exception.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="XBeeDeviceException"/> class with a specified error message.
		/// </summary>
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="XBeeDeviceException"/> class with a specified error message and the exception that is the cause of this exception.
		/// </summary>
		/// <param name="message">ThThe error message that explains the reason for this exception.</param>
		/// <param name="cause">The exception that is the cause of the current exception, or a null reference if no inner exception is specified.</param>
